...
//
//        1. Write a class with the name Rectangle. The class needs two fields with name width and length both of type double.
//
...
//
//        2. Write a class with the name Cuboid that extends Rectangle class. The class needs one field with name height of type double.
//
